...
std::vector<SpecialOperator> Language::SpecialOperators = {
    ...
    SpecialOperator{"<<",   SourceToken::Type::BitshiftLeft},
    SpecialOperator{">>",   SourceToken::Type::BitshiftRight},
};
...
std::vector<SpecialCharacter> Language::SpecialCharacters = {
    ...
    SpecialCharacter{'*',   SourceToken::Type::Asterisk},
    SpecialCharacter{'/',   SourceToken::Type::Slash},
    ...
    SpecialCharacter{'^',   SourceToken::Type::Caret},
